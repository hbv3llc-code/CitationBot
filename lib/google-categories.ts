// Full Google Business Profile category list (~4000 categories)
// Base source: Google My Business Categories (manchumahara gist, 2022)
// Supplemented with categories added by Google since then
export const GOOGLE_BUSINESS_CATEGORIES: string[] = [
  ...
  "Portable toilet supplier",
  "Debris removal service",
  "Construction and demolition contractor",
